...
function movement_and_collision_1_4() {
	...
	if(_mv_dir == _no_direction || _mv_spd == 0 || _count > _limit) return false;
	...
	do
	{
	  ...
	  repeat(2)
	  {
	    ...
	    if(!place_meeting(_testx, _testy, _wall)) //We found an opening.  Go ahead and move towards that.
	        return movement_and_collision_1_4(_test_dir, _mv_spd, _wall, _count);
